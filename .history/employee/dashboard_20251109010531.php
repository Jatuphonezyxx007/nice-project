            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body text-center">
                    ...
                    <?php elseif ($has_checked_in): ?>
                        ...
                        <div id="#webcam-container-checkout video" class="mb-3">
                    ...
                    <?php else: ?>
                        ...
                        <div id="#webcam-container-checkin video" class="mb-3">
