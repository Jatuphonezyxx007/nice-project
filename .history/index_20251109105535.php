...
// (*** ใหม่ ***) ตรวจจับข้อความ Error จาก URL (จาก header.php)
if (isset($_GET['error']) && $_GET['error'] == 'timeout') {
    $error_message = 'เซสชันหมดอายุเนื่องจากไม่มีการใช้งานนานเกินไป กรุณา Login ใหม่อีกครั้ง';
}
