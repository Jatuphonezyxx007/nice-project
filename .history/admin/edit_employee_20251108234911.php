                        ...
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                ...
                                <select name="prefix_en" class="form-control" required>
                                    <option value="Mr." <?php echo ($employee['prefix_en'] == 'นาย') ? 'selected' : ''; ?>>นาย</option>
                                    <option value="Miss" <?php echo ($employee['prefix_en'] == 'นาง') ? 'selected' : ''; ?>>นาง</option>
                                    <option value="นางสาว" <?php echo ($employee['prefix_en'] == 'นางสาว') ? 'selected' : ''; ?>>นางสาว</option>
                                </select>
                            </div>
                            <div class="col-md-5 mb-3">
                                <label class="form-label">ชื่อจริง (ไทย) <span class="text-danger">*</span></label>
