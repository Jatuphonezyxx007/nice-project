                            ...
                            <?php while ($emp = $employees_result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php echo htmlspecialchars($emp['prefix_th'] . ' ' . $emp['firstname'] . ' ' . $emp['lastname']); ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($emp['role'] != 'admin'): ?>
                                            <button type="button" class="btn btn-sm btn-danger delete-btn" data-bs-toggle="modal"
                                                ...
                                                data-name="<?php echo htmlspecialchars($emp['prefix_th'] . ' ' . $emp['firstname'] . ' ' . $emp['lastname']); ?>"
                                                title="ลบ">
