                        ...
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                ...
                                <select name="prefix_en" class="form-control" required>
                                    <option value="Mr." <?php echo ($employee['prefix_en'] == 'Mr.') ? 'selected' : ''; ?>>นาย</option>
                                    <option value="Miss" <?php echo ($employee['prefix_en'] == 'Miss') ? 'selected' : ''; ?>>นาง</option>
                                    <option value="Mrs." <?php echo ($employee['prefix_en'] == 'Mrs.') ? 'selected' : ''; ?>>นางสาว</option>
                                </select>
                            </div>
                            <div class="col-md-5 mb-3">
