        ...
        <div class="col-md-10">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">
                    แก้ไขข้อมูลสำหรับ: <?php echo htmlspecialchars($employee['prefix'].' '.$employee['firstname'] . ' ' . $employee['lastname']); ?>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                ...
                                <select name="prefix" class="form-control" required>
                                    <option value="นาย" <?php echo ($employee['prefix'] == 'นาย') ? 'selected' : ''; ?>>นาย</option>
                                    <option value="นาง" <?php echo ($employee['prefix'] == 'นาง') ? 'selected' : ''; ?>>นาง</option>
                                    <option value="นางสาว" <?php echo ($employee['prefix'] == 'นางสาว') ? 'selected' : ''; ?>>นางสาว</option>
                                </select>
                            </div>
