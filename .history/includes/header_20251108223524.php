...
// (ใหม่) กำหนดลิงก์หน้าหลักตามสิทธิ์
$home_link = ($current_user_role == 'admin') ? BASE_URL . '/admin/dashboard.php' : BASE_URL . '/employee/dashboard.php';
?>
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <style>
        body { 
            background-color: #f8f9fa; /* (ใหม่) ปรับสีพื้นหลังให้สว่างขึ้นเล็กน้อย */
        }
        /* (ใหม่) ปรับ Dropdown ให้อยู่ชิดขวาสุดเสมอ */
        .dropdown-menu-end {
            min-width: 220px;
        }
    </style>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm py-3">
    <div class="container-fluid">
        <a class="navbar-brand fw-bold" href="<?php echo $home_link; ?>"> <i class="bi bi-calendar-check-fill text-primary me-2"></i> Attendance System
        </a>
            ...
            <div class="navbar-nav">
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="navbarUserDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi bi-person-circle fs-4 me-2"></i> <span class="d-none d-lg-inline">สวัสดี, <?php echo htmlspecialchars($current_user_name); ?></span>
                    </a>
