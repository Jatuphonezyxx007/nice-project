...
require_once '../includes/header.php'; // (ไฟล์ header.php ที่คุณส่งมา)
?>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var editModal = new bootstrap.Modal(document.getElementById('editShiftModal'));
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      // (*** สำคัญ ***) บอก FullCalendar ให้ไปดึงข้อมูลจาก API ที่เราสร้าง
      events: 'api_get_schedules.php',
      ...
      eventDrop: function (info) {
        ...
        /*
        fetch('api_update_schedule_date.php', {
            method: 'POST',
            body: JSON.stringify({
    ...
    if (editShiftForm) {
      editShiftForm.addEventListener('submit', function (event) {
        ...
        fetch('api_update_shift.php', { // (*** คุณต้องสร้างไฟล์นี้ ***)
          method: 'POST',
          body: formData
        })
