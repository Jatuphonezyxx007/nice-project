            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <?php if ($current_user_role == 'admin'): ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo BASE_URL; ?>/admin/manage_shifts.php">จัดการตารางกะ</a>
                        </li>
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo BASE_URL; ?>/employee/schedule_calendar.php">ปฏิทินกะ</a>
                        </li>
                    <?php endif; ?>
                </ul>
